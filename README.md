...
Relevant Coursework: Web Engineering, Software Quality, UI/UX Design, Mobile Development, Databases, Agile Methodologies.
...
### 🦷 ConsultDent
Dental management system focused on appointments, patients and reports using agile methodologies.

### 📱 Ionic Mobile & PWA Apps
Mobile applications and PWAs focused on usability and user experience.

### 🏥 Medical Services Platform
Informative platform for medical services and student support at BUAP.
...
(*Research in Computing Science, 2025*)
...
💼 LinkedIn: [Scarlett Xochicale](https://www.linkedin.com/in/scarlett-xochicale-9b023b347/)
```
